...
export default function Footer() {
  ...
  <div className="text-white">
    ...
    >
      <span>{title}</span>
      <span>
        {openSection === id ? <FaChevronUp className="w-4 h-4 sm:w-5 sm:h-5 text-sm"  /> : <FaChevronDown className=" text-sm w-4 h-4 sm:w-5 sm:h-5"  />}
      </span>
    </div>
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-6 gap-12">
        ...
        <FooterSection
          ...
          items={[
            ...
            '+91 8826688426',
          <div key="social" className="hidden sm:block  mt-10 text-white text-sm space-y-2">
            <h4 className="font-semibold">See what we're up to</h4>
              <div className="flex space-x-4 md:text-lg  ">
                  <FaFacebookF  className='h-10 w-10 sm:h-5 sm:w-5'/>
                  <FaTwitter  className='h-10 w-10 sm:h-5 sm:w-5'/>
                  <FaInstagram className='h-10 w-10 sm:h-5 sm:w-5' />
                  <FaYoutube className='h-10 w-10 sm:h-5 sm:w-5' />
              </div>
          </div>
          ]}
        />
        ...
        <div>
        <div key="social" className=" md:hidden mt-10 text-white text-sm space-y-2">
              <h4 className="font-semibold">See what we're up to</h4>
              <div className="flex space-x-4 md:text-lg ">
                <FaFacebookF  className='h-4 w-4 sm:h-4 sm:w-4'/>
                <FaTwitter  className='h-4 w-4 sm:h-4 sm:w-4'/>
                <FaInstagram className='h-4 w-4 sm:h-4 sm:w-4' />
                <FaYoutube className='h-4 w-4 sm:h-4 sm:w-4' />
              </div>
          </div>
